...
const Comodato = () => {
  ...
  return (
    <div className="max-w-xl mx-auto mt-10 p-6 bg-white border border-gray-300 rounded-lg shadow-lg">
      <h1 className="text-center text-2xl font-bold mb-4">COMODATO BRITÂNIA ELETRÔNICOS S.A</h1>
      <div className="mb-4">
        ...
        <h2 className="text-lg font-semibold mt-4">CLÁUSULA 2° - Prazo de Duração</h2>
        ...
        <h2 className="text-lg font-semibold mt-4">CLÁUSULA 3° - Das Responsabilidades dos Contratantes</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          <div className="mb-4">
            <label htmlFor="centroDeCusto" className="block mb-2">Centro de Custo:</label>
            <input
              type="text"
              id="centroDeCusto"
              name="centroDeCusto"
          ...
          <div className="mb-4">
            <label htmlFor="patrimonio" className="block mb-2">Patrimônio:</label>
            <input
              type="text"
              id="patrimonio"
              name="patrimonio"
          ...
          <button type="submit" className="bg-blue-500 text-white rounded p-2 hover:bg-blue-600 transition duration-300 w-full">Enviar</button>
        </form>
      </div>
    </div>
  );
