...
const Comodato = () => {
  ...
  return (
    <div className="comodato-container">
      <h1 className="comodato-title text-2xl font-bold text-center py-4">COMODATO BRITÂNIA ELETRÔNICOS S.A</h1>
      <div className="comodato-content p-6">
        ...
        <h2 className="text-xl font-semibold mb-2">CLÁUSULA 2° - Prazo de Duração</h2>
        ...
        <h2 className="text-xl font-semibold mb-2">CLÁUSULA 3° - Das Responsabilidades dos Contratantes</h2>
        ...
        <form onSubmit={handleSubmit} className="comodato-form">
          ...
          {/* Centro de Custo */}
          <div className="form-group mb-4">
            <label htmlFor="centroDeCusto" className="block text-lg">Centro de Custo:</label>
            <input
              type="text"
              id="centroDeCusto"
              name="centroDeCusto"
          ...
          {/* Setor (ReadOnly) */}
          <div className="form-group mb-4">
            <label htmlFor="setor" className="block text-lg">Setor:</label>
            <input
              type="text"
              id="setor"
              name="setor"
          ...
          {/* Usuário */}
          <div className="form-group mb-4">
            <label htmlFor="usuario" className="block text-lg">Usuário:</label>
            <input
              type="text"
              id="usuario"
              name="usuario"
          ...
          {/* Patrimônio */}
          <div className="form-group mb-4">
            <label htmlFor="patrimonio" className="block text-lg">Patrimônio:</label>
            <input
              type="text"
              id="patrimonio"
              name="patrimonio"
        ...
        {/* Mensagem de erro */}
        {errorMessage && <div className="error-message text-red-500 text-center mt-4">{errorMessage}</div>}
